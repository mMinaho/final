...
function saveAssignment(type_selected,assignment){
  var assignments_of_type = getAssignmentsByType(type_selected);
  assignments_of_type.push(JSON.stringify(assignment));
  localStorage.setItem(type_selected,assignments_of_type.join("|"));
}

function register(){
 var type_selected = getSelectedType("type");
...
function display(){
  ...
  var type_selected = getSelectedType("type_display");
  var assignments_of_type;
  if (type_selected == 'all'){
    assignments_of_type = getAssignmentsByType("homework").concat(getAssignmentsByType("report")).concat(getAssignmentsByType("test"));
  }else{
    assignments_of_type = getAssignmentsByType(type_selected);
  }
  console.log(assignments_of_type)
  showAssignments(assignments_of_type);
}
